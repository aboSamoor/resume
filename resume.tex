...
% & \footnotesize{\parbox{\twidthb}{Designed a multilingual coreference resolution system for the SAFT team. The results will be published and I am currently preparing the draft paper.}}

\\\textsc{Jun - Aug 11}  & \textbf{Software Engineering Intern}, \emph{Google}, Mountain View, CA. \\
%						& \footnotesize{\parbox{\twidthb}{ Worked on visualizing Google network infrastructure in the sandcastle team.}}
...
\raggedleft{\textsc{ Aug 12}} & \textbf{SpeedRead: A Fast Named Entity Recognition Pipeline}.\\ & \scriptsize{Submitted to COLING (under review).}\\
\raggedleft{\textsc{ Aug 12}} & \textbf{Detecting English Writing Styles For Non-native Speakers}.\\ & \scriptsize{Submitted to COLING (under review).}\\
         \end{tabular}
\\
