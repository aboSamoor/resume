...
\begin{tabular}{p{\twidtha} p{\twidthb}}
\raggedleft{\textsc{Oct 13}} & \textbf{Multilingual Coreference Resolution using Distributed Word Representations}.\\ & \scriptsize{Rami Al-Rfou', Jenny Liu, Amarnag Subramanya, Jay Ponte, Kai Chen, Fernando Pereira. \textit{EMNLP 2013}, Seattle, Washington, USA. }\\
