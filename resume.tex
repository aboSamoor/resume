...
\newcommand{\twidtha}{3.0cm}
      ...
      \href{mailto:ralrfou@cs.stonybrook.edu}{\so{ralrfou@cs.stonybrook.edu}} \,\,\,\,\,\,\,\,\,\, \url{www.cs.stonybrook.edu/~ralrfou} \\
       \so{+631 371 3165}
            \end{center}
...
Recognition Pipeline}.\\ & \scriptsize{Rami Al-Rfou' and Steven Skiena. \textit{International Conference on Computational Linguistics (COLING 2012)}, IIT Bombay, Mumbai, India. }\\
...
\section{Projects}
\begin{tabular}{p{\twidtha} p{\twidthb}}
\raggedleft{\textsc{ Aug 12}} & \textbf{Detecting English Writing Styles For
Non-native Speakers}.\\ & \scriptsize{Rami Al-Rfou'. ArXiv e-prints, Computation and Language section. \url{http://arxiv.org/abs/1211.0498}}\\
\raggedleft{\textsc{ Jan 11}} & \textbf{TrackMeNot-so-good-after-all}.\\ &
\scriptsize{Rami Al-Rfou', William Jannen, and Nikhil Patrwardhan. ArXiv e-prints, Information Retrieval \& Privacy sections. \url{http://arxiv.org/abs/1211.0320}}\\
\end{tabular}
...
\cvdoublecolumn{\cvreference{Steven Skiena}
