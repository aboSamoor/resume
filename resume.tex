...
\newcommand{\twidtha}{3.0cm}
      ...
      \url{www.cs.stonybrook.edu/~ralrfou} && 350 Circle Rd. Stony Brook,  NY 11790 \\
      \end{tabular}
      \end{center}
...
\\\textsc{May - Aug 13}  & \textbf{Research Intern}, \emph{Microsoft}, New York City, NY. \\                    
 & \footnotesize{\parbox{\twidthb}{Worked with Leon Bottou on active learning and prior knowledge integration.}}
...
\raggedleft{\textsc{Apr 14}} & \textbf{Polyglot-NER: Massive Multilingual Named Entity Recognition}.\\ & \scriptsize{Rami Al-Rfou', Vivek Kulkarni, Bryan Perozzi, and Steven Skiena.}\\
...
\begin{tabular}{lllHH}
\textbf{Steven Skiena}& \textbf{Yejin Choi} & \textbf{Leon Bottou} & \textbf{Jay Ponte} & \textbf{Amarnag Subramanya}\\
